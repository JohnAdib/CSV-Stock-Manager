  ...
  return (
    <div className="">
      <div className="relative isolate px-6 pt-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-12 sm:pt-24 lg:pt-32">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 dark:text-gray-200">
              ...
              <a
                href="https://github.com/JohnAdib/CSV-Stock-Manager"
                target="_blank"
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
              A full-stack app for managing inventory data from CSV files.
              Easily upload, validate, and edit stock data with a responsive UI.
              Built with Node.js, Prisma, and Next.js, and ready for cloud
              deployment.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button href="/stock" color="sky">
                Get Started
              </Button>
              <Link
                href="/about"
